...
public abstract class BaseToggleSwitch extends LinearLayout implements View.OnClickListener {
    ...
    protected static class Default {
        ...
        protected static final int ACTIVE_BG_COLOR = R.color.error;
        protected static final int ACTIVE_TEXT_COLOR = android.R.color.white;
        protected static final int INACTIVE_BG_COLOR = R.color.lightGray;
        protected static final int INACTIVE_TEXT_COLOR = R.color.lb_grey;
        protected static final int SEPARATOR_COLOR = R.color.dark;

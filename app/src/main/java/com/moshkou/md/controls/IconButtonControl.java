...
public class IconButtonControl extends AppCompatButton {
    ...
    public IconButtonControl(Context context) {
        super(context);
        init(context, null);
    }

    public IconButtonControl(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public IconButtonControl(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            float defaultDrawablePadding = getResources().getDimension(R.dimen.icon_button_padding);
